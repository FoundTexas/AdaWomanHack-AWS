...
import { Box, Chip, Typography, IconButton, Grid } from '@mui/material'
...
React.useEffect(() => {
  ...
  function editTags() {
    axios.put(`https://azul-api.ccmchallenges.com/videos/${video.employee_id}/${video.call_timestamp}`, {
        tags: updatedTags
    },
    {
      headers: {
    ...
    }).then((response) => { setNewVideo(response.data); });
  }
      ...
      >
        <PlusIcon fontSize="inherit" />
            ...
            <Popover
              ...
              <Button variant="contained" sx={{marginRight: '5%', marginBottom: '2%', marginTop: '2%'}} onClick={() => {updateTags(); handleCloseAdd(); setOpenLogoutEdit(true);}}>Save</Button>
